...
file_struct!(FreeBikeStatusFile, FreeBikeStatusData);
...
pub struct Bike {
    ...
    /// The [VehicleType](crate::v2_3::files::vehicle_types::VehicleType) of this vehicle.
    ...
    /// If the vehicle is currently at a [Station](crate::v2_3::files::station_information::Station).
    pub station_id: Option<StationID>,
    /// The [Station](crate::v2_3::files::station_information::Station) where this vehicle must be returned to.
    pub home_station_id: Option<StationID>,
    /// The [PricingPlan](crate::v2_3::files::system_pricing_plans::SystemPricingPlan) this vehicle is eligible for.
    ///
    /// If this field is defined it supersedes [default_pricing_plan_id](crate::v2_3::files::system_information::SystemInformation::default_pricing_plan_id).
