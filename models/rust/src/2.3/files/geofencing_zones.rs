...
#[cfg(doc)]
use crate::v2_3::files::geofencing_zones;
#[cfg(doc)]
use crate::v2_3::files::station_information;
...
pub struct Rule {
    ...
    pub vehicle_type_id: Option<Vec<VehicleTypeID>>,
    /// Is the ride allowed to start and end in this zone?
